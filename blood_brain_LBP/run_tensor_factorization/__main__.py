...
from blood_brain_LBP.run_tensor_factorization.factorization_run import run_tensorcell2cell

from blood_brain_LBP.run_tensor_factorization.enrichment_run import (
...
if __name__ == "__main__":
    ...
    try:
        ...
        adata_bl, adata_br = prepare_scran_de_data_micro_mono(
            args.batch, args.project_path, "cell_type.v2", "cell_type.v2"
        )
    ...
    if args.factorization_type == "brain_coarse":
        ...
        ## UPLOAD ALREADY DEG COMPUTED
        adata_tf = sc.read(
            args.project_path / args.batch / "c2c_liana_outputs" / "blood_brain_tf.h5ad"
        )
        enrich_mono_micro_blood_brain(
            args.batch,
            loadings_folder,
